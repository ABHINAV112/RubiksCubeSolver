    ...
    for i in range(1,5):
        while True:
            if(a.cube[i][1][0] == 'w'):
                ...
                if(i+1!=5):
                    if(a.cube[i+1][1][2] == a.cube[i+1][1][1]):
                        Moves.append(myMapping[i+1][0])
                        ExecCubeOperation('a',myMapping[i+1][0])
                    else:
                        colorIndex = a.colors.index(a.cube[i+1][1][2])
                        ...
                        Moves.append(Moves.append(myMapping[i+1][0]))
                        ExecCubeOperation("a",myMapping[i+1][0])
                        for j in range(movingNumbers[i-1]):
                            Moves.append(myMapping[0][1])
                            ExecCubeOperation("a",myMapping[0][1])
                else:
                    if(a.cube[i-3][1][2] == a.cube[i-3][1][1]):
                        Moves.append(myMapping[i-3][0])
                        ExecCubeOperation("a",myMapping[i-3][0])
                    else:
                        colorIndex = a.colors.index(a.cube[i-3][1][2])
                        for j in range(colorIndex-1):
                            SwapArray(movingNumbers)
                        for j in range(movingNumbers[i-1]):
                            Moves.append(myMapping[0][0])
...
for k in range(1000):
    for i in range(1,5):
        if(a.cube[i][0][2] == 'w'):
            if(i-1!=0):
                if(a.cube[i-1][0][0] == a.cube[i-1][1][1]):
                    Moves.append(myMapping[i][1])
                    ExecCubeOperation("a",Moves[-1])
                    Moves.append(myMapping[5][1])
                    ExecCubeOperation("a",Moves[-1])
                    Moves.append(myMapping[i][0])
                    ExecCubeOperation("a",Moves[-1])
                else:
                ...
                if(a.cube[i+3][0][0] == a.cube[i+3][1][1]):
                    Moves.append(myMapping[i][1])
                    ExecCubeOperation("a", Moves[-1])
                    Moves.append(myMapping[5][1])
                    ExecCubeOperation("a", Moves[-1])
            ...
            if(i+1!=5):
                if(a.cube[i+1][0][2] == a.cube[i+1][1][1]):
                    Moves.append(myMapping[i][0])
                    ExecCubeOperation("a",Moves[-1])
                    Moves.append(myMapping[5][0])
                    ExecCubeOperation("a",Moves[-1])
                    ...
                    ExecCubeOperation("a", Moves[-1])            
            if(i+1 == 5):
                if(a.cube[i-3][0][2] == a.cube[i-3][1][1]):
                    Moves.append(myMapping[i][0])
                    ExecCubeOperation("a", Moves[-1])
                    Moves.append(myMapping[5][0])
                    ExecCubeOperation("a", Moves[-1])
            ...
            for j in range(1,5):        
                if(a.cube[5][yellowCorners[j-1][0]][yellowCorners[j-1][1]]=='w'):
                    Moves.append(myMapping[j][0])
                    ExecCubeOperation("a",Moves[-1])
                    Moves.append(myMapping[5][0])
                    ExecCubeOperation("a",Moves[-1])
                    Moves.append(myMapping[5][0])
                    ExecCubeOperation("a",Moves[-1])
                    Moves.append(myMapping[j][1]) 
                    ExecCubeOperation("a",Moves[-1])
    ExitList = []
    for i in range(1,5):
    ...
    for i in range(1,5):
        if(a.cube[i][0][1]==a.cube[i][1][1]):
            if(a.cube[5][middleLayer[i-1][0]][middleLayer[i-1][1]] == a.cube[leftSide[i-1]][1][1]):
                Moves.append(myMapping[5][1])
                ExecCubeOperation("a",Moves[-1])
                Moves.append(myMapping[leftSide[i-1]][1])
                ExecCubeOperation("a",Moves[-1])
                Moves.append(myMapping[5][0])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[leftSide[i-1]][0])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[5][0])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[i][0])
                ...
                Moves.append(myMapping[5][0])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[rightSide[i-1]][0])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[5][1])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[rightSide[i-1]][1])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[5][1])
                ExecCubeOperation("a", Moves[-1])
                Moves.append(myMapping[i][1])
...
while True:
    ...
    if(a.cube[0][1][0] == 'y' and a.cube[0][1][2] == 'y' and not(exitCondition)):
        Moves.append(myMapping[3][0])
        ExecCubeOperation("a",Moves[-1])
        Moves.append(myMapping[4][0])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[0][0])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[4][1])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[0][1])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[3][1])
        ExecCubeOperation("a", Moves[-1])
...
while True:
    ...
    if(case == 0):
        ...
        Moves.append(myMapping[0][1])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[2][0])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[0][0])
        ExecCubeOperation("a", Moves[-1])
    elif(case!='perfect'):
        Moves.append(myMapping[backSide[case-1]][0])
        ExecCubeOperation("a",Moves[-1])
        Moves.append(myMapping[0][1])
        ExecCubeOperation("a",Moves[-1])
        Moves.append(myMapping[case][1])
        ExecCubeOperation("a",Moves[-1])
        Moves.append(myMapping[0][0])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[backSide[case-1]][1])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[0][1])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[case][0])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[0][0])
        ExecCubeOperation("a", Moves[-1])
    if(case == 'perfect'):
...
for i in range(1,5):
    for j in range(algoTimes[i-1]):
        Moves.append(myMapping[1][0])
        ExecCubeOperation("a",Moves[-1])
        Moves.append(myMapping[5][0])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[1][1])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[5][1])
        ExecCubeOperation("a", Moves[-1])
        Moves.append(myMapping[1][0])
